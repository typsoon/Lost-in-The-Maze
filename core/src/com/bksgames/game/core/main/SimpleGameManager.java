...
public class SimpleGameManager implements GameManager {
    ...
    public <T extends Update> boolean sendUpdate(UpdateHolder<T> updateHolder, PlayerColor playerColor) {
            ...
            if(playerColor==activePlayer && update instanceof LaserUpdate laserUpdate) {
                System.out.println(laserUpdate.getRelativeX() + " " + laserUpdate.getRelativeY() + " " + laserUpdate.getDirection() + " " + laserUpdate.getDeflectedDirection());
            }
