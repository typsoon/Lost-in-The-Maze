...
//    TODO: TUDUDU TUDUDU
    ...
    @Override
    public synchronized boolean sendMove(IncompleteMove incompleteMove, Point minionPosition) {
        return gameService.acceptAction(incompleteMove, getPlayerColor(), minionPosition);
    }
